...
alignedDataDir = os.path.join(initialDirectory,
                              'selected_experiments/L2_lumCon')
...
current_exp_ID = '200508bg_fly1'
current_t_series ='TSeries-05082020-0942-005'
Genotype = 'L2_21DhhGal4'
Age = '2-3'
Sex = 'f'
...
transfer_type = 'predefined' # 'minimal' 'predefined'
transfer_data_name = '200226bg_fly5-TSeries-002_SIMA-STICA.pickle'
